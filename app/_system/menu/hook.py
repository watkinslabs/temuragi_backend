...
def register_menu_injector(app):
    ...
    def inject_menu_functions():
        ...
        """
        return {
            'get_menu': lambda menu_type=menu_tree, user_id=None: 
                get_menu_builder().get_menu_structure(menu_type, user_id),
            ...
            'get_quick_links': lambda user_id:
                get_menu_builder().get_user_quick_links(user_id),
            'render_quick_links': lambda user_id, template_path=None, template_string=None, **kwargs:
                get_menu_builder().render_user_quick_links(user_id, template_path, template_string, **kwargs),
