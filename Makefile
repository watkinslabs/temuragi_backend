...
report:
	@--python -m app.cli model_report generate Report -c SYSTEM --slug 'report2/list' --name 'Manage Report Definitions' --description 'Template metadata specific configurations' --system
